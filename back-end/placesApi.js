...
async function GooglePlaces(state, callback) {
   return await rp.get(`https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${state.latLng.lat},${state.latLng.lng}&radius=1500000&type=${state.type}&fields=name,rating&key=AIzaSyCHJL5eNLo3w6kFDG6WWRPZqMCQzEzQDmE
   `
