    ...
    render() {
        return (
            ...
            <div className='addTrip'>
                ...
                <input id="Country" name="Country" list="options" onChange={this.handleChange} onSelect={this.handleSelect} placeholder="Your Country" ></input>
                <datalist id="options">
               ...
               <div id="dataList">
                <p>
                    <label for="chk-demo1" onClick={this.changeHome}>
                        ...
                        <span  className="checkbox">Extream</span>
                    </label>
                </p>
                <p>
